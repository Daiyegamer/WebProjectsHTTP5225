...
?>
    <section class="order">
        ...
        <div class="container">
            <p>Ready to make your website stand out? Let's create a custom favicon for your site!</p>

            <p><strong>How?</strong> Just upload an image or drag and drop it onto the page, then convert it into a favicon with one click!</p>
